...
const getAjaxFormController = (req,res) =>{
    res.render('ajaxform/form');
}

const postBasicDetailsController = (req,res) =>{
    let str = req.body;
...
const postEducationDetailsController= (req,res) =>{
    let str = req.body;
...
const postWorkExperienceController = (req,res) =>{
    let str = req.body;
...
const postLanguageController = (req,res) =>{
    let str = req.body;
...
const postTechnologyController = (req,res) =>{
    let str = req.body;
...
const postReferenceController = (req,res) =>{
    let str = req.body;
...
const postPreferenceController =(req,res) =>{
...
module.exports ={getAjaxFormController,postBasicDetailsController,postEducationDetailsController
                ,postWorkExperienceController,postLanguageController,postTechnologyController
                ,postReferenceController,postPreferenceController};