...
const getSimpeFormController = (req,res) =>{
    res.render('simpleform/form'); 
}

const postSimpeFormController = (req,res) =>{
    //basic details
...
const postUpdateController = (req,res) =>{
    var id = req.body.id;
...
module.exports = {getSimpeFormController,postSimpeFormController,getUpdateController,postUpdateController};